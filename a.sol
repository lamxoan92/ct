...
contract Aquaman is ERC20, Ownable {
    ...
    constructor() payable ERC20("Aquaman", "AQUA") {
        ...
        treasuryWallet = 0x144B8cAb7C37FCD0c5BDDe8D9C0219017c3308E7;

        dividendTracker = new DividendTracker(287_000_000, rewardToken);
        ...
        _mint(owner(), 287_000_000_000 * (10 ** 9));
    ...
    function _transfer(
        ...
        _buyBlock[to] = block.number;  // Sandwich bot Can't buy sell in same block!
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if((treasuryFeeOnBuy + treasuryFeeOnSell) > 0) {
                    ...
                    uint256 half = treasuryBNB / 2;

                    sendBNB(payable(treasuryWallet), half);
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > totalSupply() / 1000_000, "SwapTokensAtAmount must be greater than 0.000001% of total supply");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200_000 && newValue <= 5000_000, "gasForProcessing must be between 200,000 and 5000,000");
